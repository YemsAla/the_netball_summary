...
class MatchReportForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'opponent_name': forms.TextInput(attrs={'class': 'form-control'}),
            'team_score': forms.NumberInput(attrs={'class': 'form-control'}),
            'opponent_score': forms.NumberInput(attrs={'class': 'form-control'}),
            'match_report': forms.Textarea(attrs={'class': 'form-control', 'rows': 5}),
