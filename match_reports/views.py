...
class ReportCreateView(LoginRequiredMixin, CreateView):
    ...
    def form_valid(self, form):
        ...
        messages.success(
            self.request, 'Your match report has been successfully created.')
...
class ReportUpdateView(LoginRequiredMixin, UserPassesTestMixin, UpdateView):
    ...
    def form_valid(self, form):
        messages.success(
            self.request, 'You\'ve successfully updated your match report.')
        return super().form_valid(form)
...
class ReportDeleteView(LoginRequiredMixin, UserPassesTestMixin, DeleteView):
    ...
    def form_valid(self, form):
        messages.success(
            self.request, 'You\'ve successfully deleted your match report.')
        return super().form_valid(form)
...
def register(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            login(request, user)
            messages.success(
                request, f'Welcome to The Netball Summary, {user.username}!')
